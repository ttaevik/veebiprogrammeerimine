<?php
	class Photoupload {
		...
		/*public $testPublic;
		private $testPrivate;*/
		//protected $testProtected; kolmas tüüp
		private $tempName;
		...
		public function resizeImage($width, $height){
			$this->createImage();//teeb myTempImage valmis
		...
		public function addWatermark($marginHor, $marginVer){
			...
			$stampPosY = imagesx($this->myImage) - $stampHeight - $marginVer;
		...
		public function addTextWatermark($text){
			...
			imagettftext($this->myImage, 20, 0, 10, 25, $textColor, "../../graphics/ARLRDBD.TTF", $text);
		}
